...
$complekt = mysql_fetch_array(mysql_query("SELECT * FROM complekt WHERE link='$_GET[link]'"));
?>
...
<head>
    ...
    <title><?if($complekt['title'] != '') echo $complekt['title']; else echo $rez['t']; ?></title>
    ...
    <meta name="description" content="<?if($complekt['description'] != '') echo $complekt['description']; else echo $rez['d']; ?>"/>
    <meta name="keywords" content="<?if($complekt['keywords'] != '') echo $complekt['keywords']; else echo $rez['k']; ?>">
    ...
    <div class="span12 content">
        ...
        if (isset($_GET['page']) and $_GET['page'] != '') {
            ...
            switch ($_GET['page']) {
                ...
                case("book_reviews"):
                    include 'page/book_reviews.php';
                    break;
                case("service_calc"):
                    include 'page/serv_calc.php';
                    break;
                case("order_online"):
                    include 'page/order_online.php';
                    break;
                case("callback"):
                    include 'page/callback.php';
                    break;


                case("site_map"):
                    include 'page/site_map.php';
                    break;
        ...
        ?>
            ...
            <div class="fasebook">
                <div class="divs">
                    ...
                    <p><a href="http://www.odnoklassniki.ru/profile/532410973270" target="_blank"><img
                                src="/img/34360e.png" alt="Карпаты АвтоЦентр в Одноклассниках">odnoklassniki.ru</a></p>

                    <p><a href="http://vk.com/id_karpaty_autocenter" target="_blank"><img src="/img/Logo_Vkontake.png"
                                                                                          alt="Карпаты АвтоЦентр ВКонтакте">vkontakte.ru</a>
                    </p>
            ...
            <ul class="services-menu" style="list-style:none;">
                ...
                <li class="pic configure">
                    <a href="http://karpaty-autocenter.com.ua/configurator/" class="cboxConfigure  cboxElement"
                       title="Конфигуратор автомобилей">
                ...
                <li style="background-image:url(http://karpaty-autocenter.com.ua/img/menu/notebook-b.png)">
                    <a target="_blank" href="http://karpaty-autocenter.com.ua/book_reviews/" class="right_menu_link"
                       title="Электронная книга отзывов">
...
<script>
    ...
    (function ($) {
        ...
        $('#rotator').rotator({
            fx: 'slide', autorun: true, nav: true, random: false, slides: [
...
<script type="text/javascript">
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function () {
            try {
                w.yaCounter26914833 = new Ya.Metrika({
                    id: 26914833,
                    clickmap: true,
                    trackLinks: true,
...
<noscript>
    <div><img src="//mc.yandex.ru/watch/26914833" style="position:absolute; left:-9999px;" alt=""/></div>
</noscript>
